...
export const createGarden = async (userId: number, name: string, rows: number, cols: number): Promise<Garden> => {
...
export const upsertCell = async (gardenId: number, row: number, col: number, plantId: number): Promise<void> => {
